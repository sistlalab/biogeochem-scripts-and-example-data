...
stds$sampleID<-as.numeric(as.character(stds$sampleID))
stdcurve<-summary(lm(sampleID~value, stds))
...
means<-aggregate(value~sampleID, POXCdata_melt0, "mean")
```
...
POXC_means<- merge(POXCweight, means, by.x = "Soil_ID", by.y = "sampleID")
